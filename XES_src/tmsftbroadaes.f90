   ...
   double precision alpha,ra2,eps(420),tm2(420)
   double precision emin,emax,de,spec_sum,exx,fact
   double precision , parameter :: pi = 3.1415926535897932385d0
   integer i_pts, i_st, n_st
   character c

   OPEN(30,file='tmsft_aes.dat',status='old',form='formatted')
   OPEN(60,file='tmsftbroad_aes.dat',status='unknown',form='formatted')
